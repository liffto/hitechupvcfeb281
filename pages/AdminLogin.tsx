    ...
    <div className="min-h-screen bg-[#F4F9F1] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-[40px] shadow-2xl shadow-primary/10 p-10 md:p-14 border border-gray-100">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-black tracking-tight mb-2">Back Office</h1>
          <p className="text-gray-400 font-bold text-xs uppercase tracking-widest">Hi-Tech Management Portal</p>
        </div>

        <form onSubmit={handleLogin} className="space-y-6">
          <div className="relative group">
            <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Access Password</label>
            ...
            {error && <p className="text-red-500 text-[10px] font-bold uppercase mt-3 ml-1 tracking-wider">{error}</p>}
          </div>

          <button 
            type="submit"
            className="w-full bg-primary text-white py-5 rounded-2xl font-bold text-lg shadow-xl shadow-primary/20 hover:bg-primary-dark hover:scale-[1.02] transition-all active:scale-95 flex items-center justify-center gap-3"
          >
