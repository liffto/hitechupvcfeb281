  ...
  return (
    <Layout settings={settings}>
      ...
      <div className="bg-[#F4F9F1] py-14 text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-black tracking-tight">About Us</h1>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 md:py-32">
        <div className="text-center mb-16 md:mb-20">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">Our Strength</h2>
          ...
          <div className="space-y-8">
            {settings.strengths.map((s) => (
              <div key={s.id} className="flex items-center gap-6 group">
                ...
                <p className="font-bold text-gray-800 text-lg md:text-xl leading-tight">
                  {s.text}
                </p>
              </div>
            ))}
      ...
      {settings.certificates && settings.certificates.length > 0 && (
        <div className="bg-white py-20 md:py-32 border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16 md:mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">Our Certificates</h2>
              <div className="w-12 h-1 bg-primary mt-2 rounded-full mx-auto"></div>
              <p className="text-gray-500 max-w-3xl mx-auto font-medium text-base md:text-lg mt-6">
                Our commitment to quality is backed by international standards and recognized certifications.
              </p>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-12">
              {settings.certificates.map((url, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 transition-all hover:shadow-2xl hover:-translate-y-2 group overflow-hidden">
